...
class Process():
    ...
    def goodness_of_variance_fit(self, array, classes):
        ...
        Given an array and a number of classes, determine gvf
        Aids in determining optimal jenks breaks for classification of SWE
    ...
    def classify(self,value, breaks):
        """
        --Jenks Classification--
        classify a value into a given bin 
